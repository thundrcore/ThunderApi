...
class CreateDocumentExport implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'query_type' => '\ThunderCore\Invoice\Billingo\Model\DocumentExportQueryType',
'start_date' => '\DateTime',
'end_date' => '\DateTime',
'document_block_id' => 'int',
'export_type' => '\ThunderCore\Invoice\Billingo\Model\DocumentExportType',
...
'sort_by' => '\ThunderCore\Invoice\Billingo\Model\DocumentExportSortBy',
'other_options' => '\ThunderCore\Invoice\Billingo\Model\DocumentExportOtherOptions',
'filter_extra' => '\ThunderCore\Invoice\Billingo\Model\DocumentExportFilterExtra'    ];
...
'filter_extra' => 'getFilterExtra'    ];
     ...
     * Gets query_type
     *
     * @return \ThunderCore\Invoice\Billingo\Model\DocumentExportQueryType
     */
     ...
     * Sets query_type
     *
     * @param \ThunderCore\Invoice\Billingo\Model\DocumentExportQueryType $query_type query_type
     *
     * @return $this
     */
     ...
     * Gets export_type
     *
     * @return \ThunderCore\Invoice\Billingo\Model\DocumentExportType
     */
     ...
     * Sets export_type
     *
     * @param \ThunderCore\Invoice\Billingo\Model\DocumentExportType $export_type export_type
     *
     * @return $this
     */
     ...
     * Gets sort_by
     *
     * @return \ThunderCore\Invoice\Billingo\Model\DocumentExportSortBy
     */
     ...
     * Sets sort_by
     *
     * @param \ThunderCore\Invoice\Billingo\Model\DocumentExportSortBy $sort_by sort_by
     *
     * @return $this
     */
     ...
     * Gets other_options
     *
     * @return \ThunderCore\Invoice\Billingo\Model\DocumentExportOtherOptions
     */
     ...
     * Sets other_options
     *
     * @param \ThunderCore\Invoice\Billingo\Model\DocumentExportOtherOptions $other_options other_options
     *
     * @return $this
     */
     ...
     * Gets filter_extra
     *
     * @return \ThunderCore\Invoice\Billingo\Model\DocumentExportFilterExtra
     */
     ...
     * Sets filter_extra
     *
     * @param \ThunderCore\Invoice\Billingo\Model\DocumentExportFilterExtra $filter_extra filter_extra
     *
     * @return $this
     */
