...
class ProductApi
{
     ...
     * Create a product
     *
     * @param  \ThunderCore\Invoice\Billingo\Model\Product $body Product object that you would like to store. (required)
     *
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ThunderCore\Invoice\Billingo\Model\Product
     */
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ThunderCore\Invoice\Billingo\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductWithHttpInfo($body)
    {
        $returnType = '\ThunderCore\Invoice\Billingo\Model\Product';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThunderCore\Invoice\Billingo\Model\Product',
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ThunderCore\Invoice\Billingo\Model\ProductList
     */
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ThunderCore\Invoice\Billingo\Model\ProductList, HTTP status code, HTTP response headers (array of strings)
     */
    public function listProductWithHttpInfo($page = null, $per_page = '25', $query = null)
    {
        $returnType = '\ThunderCore\Invoice\Billingo\Model\ProductList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThunderCore\Invoice\Billingo\Model\ProductList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Update a product
     *
     * @param  \ThunderCore\Invoice\Billingo\Model\Product $body Product object that you would like to update. (required)
     * @param  int $id id (required)
     *
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
