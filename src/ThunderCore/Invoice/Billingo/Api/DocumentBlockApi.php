...
class DocumentBlockApi
{
     ...
     * @return \ThunderCore\Invoice\Billingo\Model\DocumentBlockList
     */
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ThunderCore\Invoice\Billingo\Model\DocumentBlockList, HTTP status code, HTTP response headers (array of strings)
     */
    public function listDocumentBlockWithHttpInfo($page = null, $per_page = '25')
    {
        $returnType = '\ThunderCore\Invoice\Billingo\Model\DocumentBlockList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThunderCore\Invoice\Billingo\Model\DocumentBlockList',
