...
class UtilApi
{
     ...
     * @return \ThunderCore\Invoice\Billingo\Model\TaxNumber
     */
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ThunderCore\Invoice\Billingo\Model\TaxNumber, HTTP status code, HTTP response headers (array of strings)
     */
    public function checkTaxNumberWithHttpInfo($tax_number)
    {
        $returnType = '\ThunderCore\Invoice\Billingo\Model\TaxNumber';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThunderCore\Invoice\Billingo\Model\TaxNumber',
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ThunderCore\Invoice\Billingo\Model\Id
     */
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ThunderCore\Invoice\Billingo\Model\Id, HTTP status code, HTTP response headers (array of strings)
     */
    public function getIdWithHttpInfo($id)
    {
        $returnType = '\ThunderCore\Invoice\Billingo\Model\Id';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThunderCore\Invoice\Billingo\Model\Id',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
