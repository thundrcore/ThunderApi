...
class OrganizationApi
{
     ...
     * @return \ThunderCore\Invoice\Billingo\Model\OrganizationData
     */
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ThunderCore\Invoice\Billingo\Model\OrganizationData, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrganizationDataWithHttpInfo()
    {
        $returnType = '\ThunderCore\Invoice\Billingo\Model\OrganizationData';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThunderCore\Invoice\Billingo\Model\OrganizationData',
