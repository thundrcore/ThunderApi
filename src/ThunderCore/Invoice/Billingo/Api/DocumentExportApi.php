...
class DocumentExportApi
{
     ...
     *
     * @param  \ThunderCore\Invoice\Billingo\Model\CreateDocumentExport $body Create document export body. (required)
     *
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ThunderCore\Invoice\Billingo\Model\DocumentExportId
     */
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ThunderCore\Invoice\Billingo\Model\DocumentExportId, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($body)
    {
        $returnType = '\ThunderCore\Invoice\Billingo\Model\DocumentExportId';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThunderCore\Invoice\Billingo\Model\DocumentExportId',
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ThunderCore\Invoice\Billingo\Model\DocumentExportStatus
     */
     ...
     * @throws \ThunderCore\Invoice\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ThunderCore\Invoice\Billingo\Model\DocumentExportStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function pollWithHttpInfo($id)
    {
        $returnType = '\ThunderCore\Invoice\Billingo\Model\DocumentExportStatus';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThunderCore\Invoice\Billingo\Model\DocumentExportStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
